...
public class QTeamMemberEntity extends EntityPathBase<TeamMemberEntity> {
    ...
    private static final long serialVersionUID = 90807768L;
    ...
    public QTeamMemberEntity(Class<? extends TeamMemberEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new study.moum.auth.domain.entity.QMemberEntity(forProperty("member"), inits.get("member")) : null;
